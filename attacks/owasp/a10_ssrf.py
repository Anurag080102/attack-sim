        ...
        for param in params[:5]:  # Limit parameters tested
            for payload in payloads:
                ...
                if result["vulnerable"]:
                    yield Finding(
                        title=f"SSRF Vulnerability: Internal Resource Access",
                ...
                if result["vulnerable"]:
                    ...
                    yield Finding(
                        ...
                        description=f"Critical SSRF vulnerability allows access to cloud "
                                   f"metadata endpoint. This can expose credentials and "
                                   f"sensitive instance information.",
                        evidence=f"URL: {test_url}, Payload: {payload}",
                        remediation="Block access to 169.254.169.254 and other metadata IPs. "
